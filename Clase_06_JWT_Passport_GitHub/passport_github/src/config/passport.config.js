        ...
        async (accessToken, refreshToken, profile, done) => {
            ...
            try {
                ...
                if (!user) {
                    ...
                    let newUser = {
                        first_name: profile._json.name || "No Name",
                        last_name: "",
                        email: profile._json.email,
                        age: 0, // GitHub no proporciona edad, puedes manejarlo como prefieras
                        password: '', // Usamos el ID de GitHub como base para la contraseña (encriptada)
                        loggedBy: 'GitHub'
                    }
